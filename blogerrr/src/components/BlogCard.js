...
<div className="projcard-container">
      ...
      <div className="projcard projcard-red">
        <div className="projcard-innerbox">
          <img className="projcard-img" src="https://picsum.photos/800/600?image=1080" alt="Project" />
          <div className="projcard-textbox">
      ...
      <div className="projcard projcard-green">
        <div className="projcard-innerbox">
          <img className="projcard-img" src="https://picsum.photos/800/600?image=1039" alt="Project" />
          <div className="projcard-textbox">
      ...
      <div className="projcard projcard-customcolor" style={{ '--projcard-color': '#F5AF41' }}>
        <div className="projcard-innerbox">
          <img className="projcard-img" src="https://picsum.photos/800/600?image=943" alt="Project" />
          <div className="projcard-textbox">
